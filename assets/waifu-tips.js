var live2d_path = [{'name': '22', 'index': 13}, {'name': '33', 'index': 13},
  {'name': 'aoba', 'index': 0}, {'name': 'bronya', 'index': 0},  {'name': 'chitose', 'index': 0},
  {'name': 'epsilon', 'index': 0},  {'name': 'Gantzert_Felixander', 'index': 0},  {'name': 'haru', 'index': 1},  {'name': 'haruto', 'index': 0},
  {'name': 'hibiki', 'index': 0},  {'name': 'hijiki', 'index': 0},  {'name': 'izumi', 'index': 0},  {'name': 'kesshouban', 'index': 0},
  {'name': 'koharu', 'index': 0},  {'name': 'kurumi', 'index': 0},  {'name': 'miku', 'index': 0},  {'name': 'nico', 'index': 0},
  {'name': 'nietzsche', 'index': 0},  {'name': 'ni-j', 'index': 0},  {'name': 'nipsilon', 'index': 0},  {'name': 'nito', 'index': 0},
  {'name': 'pio', 'index': 79},  {'name': 'rem', 'index': 0},  {'name': 'sagiri', 'index': 0},  {'name': 'shizuku', 'index': 0},
  {'name': 'snow_miku', 'index': 0},  {'name': 'tia', 'index': 0},  {'name': 'tororo', 'index': 0},  {'name': 'tsumiki', 'index': 0},
  {'name': 'unitychan', 'index': 0},  {'name': 'wanko', 'index': 0}, {'name': 'z16', 'index': 0}];
...
live2d_settings['modelAPI']             = '../../Resources/packages/live2d-widget-model-';
live2d_settings['tipsMessage']          = 'waifu-tips.json';            // 同目录下可省略路径
live2d_settings['hitokotoAPI']          = 'jinrishici.com';                  // 一言 API，可选 'lwl12.com', 'hitokoto.cn', 'jinrishici.com'(古诗词)

// 默认模型
live2d_settings['modelId']              = 24;            // 默认模型 ID，可在 F12 控制台找到
...
function loadModel(modelId, modelTexturesId=0) {
  ...
  console.log('id', modelId)
   ...
   loadlive2d("live2d", "Resources/packages/live2d-widget-model-"+name.name+"/assets/"+name.name+".model"+modelTexturesId.toString()+".json");
    // loadlive2d('live2d', live2d_settings.modelAPI+name+'/assets/'+name+'.model'+modelTexturesId+'.JSON', (live2d_settings.showF12Status ? console.log('[Status]','live2d','模型',modelId+'-'+modelTexturesId,'加载完成'):null));
}
...
function loadTipsMessage(result) {
    ...
    function loadOtherModel() {
        var modelId = parseInt(modelStorageGetItem('modelId'));
        ...
        showMessage('哈哈哈哈hhhhhh', 3000, true);
        // $.ajax({
    ...
    function loadRandTextures() {
        var modelId = parseInt(modelStorageGetItem('modelId'));
        var modelTexturesId = parseInt(modelStorageGetItem('modelTexturesId'));
